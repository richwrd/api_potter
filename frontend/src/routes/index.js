...
import telaListPersonagem from '../views/personagem/TelaListPersonagem.vue';
import telaCadastroPersonagem from '../views/personagem/components/TelaCadastraPersonagem.vue';
import telaAtualizaPersonagem from '../views/personagem/components/TelaAtualizaPersonagem.vue';
...
const routes = [
  ...
  },
  {
    ...
    components: {
      default: NavBar,
      telaListPersonagem: telaListPersonagem
    },
    meta: {
      title: 'Personagens'
    }
  ...
  {
    path: '/personagens/edit/:id',
    name: 'telaAtualizaPersonagem',
    components: {
      default: NavBar,
      telaAtualizaPersonagem: telaAtualizaPersonagem
    },
    meta: {
      title: 'Atualiza'
    },
  ...
  {
    path: '/personagem/create',
    name: 'telaCadastroPersonagem',
    components: {
      default: NavBar,
      telaCadastroPersonagem: telaCadastroPersonagem
    },
    meta: {
      title: 'Cadastro' 
    },
